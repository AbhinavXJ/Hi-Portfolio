    ...
    return (
        ...
        <div className=' flex flex-col gap-4  lg:grid lg:grid-rows-[auto,1fr] lg:grid-cols-[1fr,3fr] lg:gap-x-4 lg:gap-y-3'>
            ...
            <div className=''>
                ...
                <div className='flex flex-col lg:grid lg:grid-cols-3 lg:gap-x-4 lg:gap-y-2 mt-4 '>

                    <Link href={`https://github.com/${user.login}?tab=repositories`} target='_blank' className='bg-neutral-900 border-white border-opacity-15 border-[0.5px] text-xl text-white text-center rounded-sm  py-1 flex items-center justify-center' >
                        Public Repos: {user.public_repos}
                    </Link>

                    <div className='bg-neutral-900 border-white border-opacity-15 border-[0.5px] text-white text-center rounded-sm py-4 text-xl' >
                    ...
                    <div className='bg-neutral-900 border-white border-opacity-15 border-[0.5px] text-white text-center rounded-sm px-1 py-4 flex justify-center text-xl' >
            ...
            <div className=' '>
                <Card className="h-full flex flex-col gap-2 justify-evenly bg-neutral-900  border-white border-opacity-15 border-[0.5px]">
                    ...
                    <Label className="text-xl py-3 px-2 rounded-sm mx-2 text-wrap text-center text-white flex items-center justify-center border-[0.5px] border-opacity-15 border-white">
                        {user.bio}
            ...
            <div className='flex flex-col gap-4 lg:grid lg:grid-cols-[1fr,1fr,1fr] lg:gap-4  '>
                ...
                <Card className="flex flex-col bg-neutral-900 justify-between gap-4 p-4 text-white border-white border-opacity-15 border-[0.5px]">
                    <div className='bg-neutral-900 text-xl text-center border-white border-opacity-15 border-[0.5px] p-2'>
                        contribution
                    </div>
                    <div className='bg-neutral-900 text-xl text-center border-white border-opacity-15 border-[0.5px] p-2'>
